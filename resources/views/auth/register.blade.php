      ...
      <div class="contenedor-100hv">
        <form id="regForm" action="{{ route('register')}}" method="POST">
          ...
          <div >
            ...
            <p><input type="text" class="form-control rounded-pill border-0 shadow-sm px-4" placeholder="Dirección" name="direccion"></p>
          ...
          <div class="text-center d-flex justify-content-between mt-4"><p>¿Ya tienes una cuenta? <a href="{{ route('loginShow')}}" class="font-italic text-muted"> 
