      ...
      <div class="container mt-4 align-items-center">
        ...
        <div class="row align-items-center pe-5 ps-5 mt-4">
          <div class="col-md-6 order-md-2 text-center">
            <img
              src="img/especialidades/gastroenterología/Gastroenterologia.jpg"
              class="img-fluid"
          ...
          <div class="col-md-6 order-md-1">
            <div>
              <h2 class="card-title">Gastroenterología</h2>
              <p>
        ...
        <div class="row mt-4 container-fluid me-3 ms-1">
          ...
          <div class="col-sm-6 mb-5">
            <img
              src="img/especialidades/gastroenterología/endoscopia.jpg"
              class="card-img-top img-fluid"
              alt="Procedimiento 1"
            />
            <h4 class="card-title mt-3">Endoscopía</h4>
            <p>
          ...
          <div class="col-sm-6 mb-5">
            <img
              src="img/especialidades/gastroenterología/colonoscopia.jpg"
              class="card-img-top img-fluid"
              alt="Procedimiento 2"
            />
            <h4 class="card-title mt-3">Colonoscopia</h4>
            <p>
          ...
          <div class="col-sm-6 mt-3">
            <img
              src="img/especialidades/gastroenterología/ecografia.jpg"
              class="card-img-top img-fluid"
              alt="Procedimiento 3"
            />
            <h4 class="card-title mt-3">Ecografía abdominal</h4>
            <p>
          ...
          <div class="col-sm-6 mt-3">
            <img
              src="img/especialidades/gastroenterología/manometria.jpg"
              class="card-img-top img-fluid"
              alt="Procedimiento 4"
            />
            <h4 class="card-title mt-3">Manometria Esofágica</h4>
            <p>
        ...
        <div class="row mt-4 container-fluid ms-5">
          ...
          <div class="col-12 col-md-4 justify-content-center">
            <div class="card" style="width: 15rem">
              <img
                src="img/Doctores/doctor2.webp"
                class="card-img-top img-fluid"
                alt="..."
              />
              <div class="card-body">
                <h5 class="card-title">Dr. Arapa</h5>
                <p class="card-text">Especialidad: Gastroenterología</p>
                <p class="card-text">CPM:XXXXXX</p>
              </div>
            </div>
