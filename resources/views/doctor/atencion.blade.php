                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="apellido"
                                            placeholder="Pérez Lopez" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="edad"
                                            placeholder="30 años" readonly>
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="horario"
                                        class="col-sm-3 col-form-label col-form-label-sm">Horario</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="horario"
                                            placeholder="9:00 AM" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="fecha"
                                            placeholder="25 de Noviembre, 2023" readonly>
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="especialidad"
                                        class="col-sm-3 col-form-label col-form-label-sm">Especialidad</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="especialidad"
                                            placeholder="Cardiología" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="doctor"
                                            placeholder="Dr. García" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
